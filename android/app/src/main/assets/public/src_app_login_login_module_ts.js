...
/* harmony import */ var _codetrix_studio_capacitor_google_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @codetrix-studio/capacitor-google-auth */ 1784);
...
let LoginPage = class LoginPage {
    constructor(authService, router, utility) {
        ...
        this.user = null;
        if (!(0,_ionic_angular__WEBPACK_IMPORTED_MODULE_5__.isPlatform)('capacitor')) {
    ...
    signIn() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            yield _codetrix_studio_capacitor_google_auth__WEBPACK_IMPORTED_MODULE_4__.GoogleAuth.signIn().then(() => {
                console.log('user: ', this.user);
                this.router.navigateByUrl('/tabs/tabs/tab1', { replaceUrl: true });
            }).catch(e => {
                this.utility.presentAlert('Email Verification', e.message);
    ...
    refresh() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            const authCode = yield _codetrix_studio_capacitor_google_auth__WEBPACK_IMPORTED_MODULE_4__.GoogleAuth.refresh();
            console.log('refresh authCode : ', authCode);
        });
    }
    signOut() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            yield _codetrix_studio_capacitor_google_auth__WEBPACK_IMPORTED_MODULE_4__.GoogleAuth.signOut();
            this.user = null;
        });
    }
};
...
const createCapacitor = win => {
  ...
  const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
    ...
    const loadPluginImplementation = /*#__PURE__*/function () {
      var _ref = (0,_Users_nurudin_Documents_Projects_ionicProjects_EdenGym_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    const createPluginMethodWrapper = prop => {
      ...
      const wrapper = (...args) => {
        ...
        if (prop === 'addListener') {
          p.remove = /*#__PURE__*/(0,_Users_nurudin_Documents_Projects_ionicProjects_EdenGym_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            return remove();
          });
        }
    ...
    const addListenerNative = (eventName, callback) => {
      ...
      const remove = /*#__PURE__*/function () {
        var _ref3 = (0,_Users_nurudin_Documents_Projects_ionicProjects_EdenGym_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class WebPlugin {
  ...
  addListener(eventName, listenerFunc) {
    ...
    const remove = /*#__PURE__*/function () {
      var _ref5 = (0,_Users_nurudin_Documents_Projects_ionicProjects_EdenGym_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    Object.defineProperty(p, 'remove', {
      value: function () {
        var _ref6 = (0,_Users_nurudin_Documents_Projects_ionicProjects_EdenGym_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          console.warn(`Using addListener() without 'await' is deprecated.`);
          yield remove();
        });
  ...
  removeAllListeners() {
    ...
    return (0,_Users_nurudin_Documents_Projects_ionicProjects_EdenGym_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.listeners = {};
